...
@section('content')
    ...
    <div class="ftco-blocks-cover-1">
      <div class="ftco-cover-1 overlay innerpage" style="background-image: url({{asset('/Baru.png')}} )">
        <div class="container">
      ...
      <div class="container">
        ...
        <div class="my-3 col-12 col-sm-8 col-md-5">
            ...
            <div class="alert alert-success mr-4" role="alert">
                {{Session::get('msg')}}
                <p>Silahkan Cek Pada Menu <a href="/proses-pengajuan-user-baru">Proses Pengajuan</a></p>
            </div>
            @endif
