 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <h1>Detail Mobil/Edit Data Mobil Baru</h1>
      </div><!-- /.container-fluid -->
    </div>
    <!-- /.content-header -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <form class="form-horizontal" action="/update-mobil/{{$detailMobilBaru->id_mobil}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('put')
        <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <select  name="merk" class="form-control">
                    ...
                    <option value="{{$detailMobilBaru->dealer->id_dealer}}">{{$detailMobilBaru->dealer->nama_dealer}}</option>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input value ="{{$detailMobilBaru->nama}}"id="mobil" name="nama" placeholder="Nama Mobil" class="form-control input-md" required="" type="text">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <select  name="kategori" class="form-control">
                <option value ="{{$detailMobilBaru->kategori}}">AT (Transmisi Otomatis)</option>
                @if ($detailMobilBaru->kategori == "MT")
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
            <input value ="{{$detailMobilBaru->deskripsi}}" id="Deskripsi" name="deskripsi" placeholder="Deskripsi" class="form-control input-md" required="" type="text">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          Rp.<input value ="{{$detailMobilBaru->harga}}"id="harga" name="harga" placeholder="Harga" class="form-control input-md" required="" type="text">
