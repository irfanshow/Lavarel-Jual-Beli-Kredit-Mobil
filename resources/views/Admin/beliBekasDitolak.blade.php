...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Riwayat Pengajuan Mobil Bekas Ditolak</h1>
          </div>
          <div class="col-sm-6">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td><a href="/detail-riwayat-beli-mobil-bekas/{{$beliBaru->id_kalkulasi}}"><button class="btn btn-primary">Detail</button></a></td>
